...
class VideoCutter:
    ...
    def init_encoder(self) -> None:
        ...
        if self.codec_name == 'av1':
            # Smart cutting only encodes boundary GOPs. Favor low-latency,
            # multithreaded libaom operation while quality remains controlled
            # independently by CRF.
